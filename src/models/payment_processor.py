...
from payment import Payment, PaymentMethod, PayPalPayment
...
if __name__ == "__main__":
    ...
    payment = Payment(1, 50000, payment_method)
    payment_processor = PaymentProcessor(payment_method, PostgreSQLPaymentRepository(), EmailNotificationService())
